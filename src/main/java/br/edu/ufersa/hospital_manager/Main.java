...
public class Main {
    ...
    static void testManagerServices() {
        ...
        try {
            service.registerManager(new Manager("Alice Clone", "11122233344", "Clone St"));
    ...
    static void testDoctorServices() {
        ...
        try {
            ...
            service.updateDoctor(new Doctor("Dr. House Jr.", "12345678901", "221B Baker St", 400.0f, "123456"));
        ...
        try {
            managerService.registerDoctor(new Doctor("Dr. Duplicate", "98765432100", "Some St", 200.0f, "123456"));
    ...
    static void testPatientServices() {
        ...
        try {
            Patient patient = service.registerPatient(new Patient("John Doe", "44455566677", "Patient Rd 42", null));
        ...
        try {
            ...
            service.updatePatient(new Patient("John Doe Updated", "44455566677", "New Address 42", null));
        ...
        // Duplicate CPF (should throw)
        try {
            service.registerPatient(new Patient("John Clone", "44455566677", "Clone St", null));
            System.out.println("Should have thrown for duplicate CPF.");
        } catch (Exception e) {
            System.out.println("Duplicate CPF blocked: " + e.getMessage());
        }
